...
Live System URL: https://stellascreation.shop

Trial Accounts:

Admin Account URL: /admin_login.php

Username: stella Password: stellaluna

Customer Account URL: /customer_login.php

Email: tep@gmail.com Password: tep

How to Use:

Customer Usage: Create an account using a Gmail address Log in and browse products Add items to cart Upload photos if required Submit order Track order status in “My Orders” Use Forgot Password for email recovery.

Admin Usage: Log in using admin account Browse dashboard analytics Open orders and update their status Manage customers Review payment images and uploaded product photos.
